    ...
    const Faqs = [
        ...
        },
        {
            ...
            faqAnswer: `Person of Indian Origin (PIO) (not being a citizen of Pakistan, Bangladesh, Sri Lanka,
                        ...
                        <ul>
                            <li class="ms-5">At any time, held an Indian passport, or</li>
                            <li class="ms-5">
                                Whose father or grandfather was a citizen of India by virtue of the Constitution
        ...
        },
        {
            ...
            faqAnswer: ` <ol>
                            <li class="ms-5">
                                ...
                                <ul>
                                    <li class="ms-5">Who is a citizen of another country, but was a citizen of India at the time of, or at any time after, the commencement of the constitution, or</li>
                                    <li class="ms-5">Who is a citizen of another country, but was eligible to become a citizen of India at the time of the commencement of the constitution, or</li>
                                    <li class="ms-5">Who is a citizen of another country, but belongs to a territory that became part of India after the 15th August 1947, or</li>
                                    <li class="ms-5">Who is a child of such a citizen</li>
                                </ul>
                            </li>
                            <li class="ms-5">A person, who is a minor child of a person mentioned in clause (1)</li>
                            <li class="ms-5">Provided that no person, who is or had been a citizen of Pakistan or Bangladesh, shall be eligible for registration as an Overseas Citizen of India
                            </li>
                        </ol>`
        },
        {
            ...
            faqAnswer: `Here is the list of required documents:
                        <ul>
                            <li class="ms-5">PAN Card (Permanent Account Number)</li>
                            <li class="ms-5">PIO or OCI Card (For PIO/OCI citizens)</li>
                            <li class="ms-5">Passport (In case of NRI)</li>
                            <li class="ms-5">Passport Size Photographs</li>
                            <li class="ms-5">Address Proof</li>
                        </ul>`
        },
        {
            ...
            faqAnswer: `Under the general permission granted by RBI, the following categories can freely purchase immovable property in India:
                        <ol>
                            ...
                            <li class="ms-5">
                                Person of Indian Origin (PIO) - who is an individual (not being a citizen of Pakistan, Bangladesh, Sri Lanka, Afghanistan, China, Iran, Nepal, or Bhutan), who
                                <ul>
                                    <li class="ms-5">At any time, held an Indian Passport, or</li>
                                    <li class="ms-5">Whose father or grandfather was a citizen of India by virtue of the Constitution of India or the Citizenship Act, 1955 (57 of 1955).</li>
                                </ul>
                            </li>
                        </ol>
        ...
        },
        {
            ...
            faqAnswer: `<ol>
                            <li class="ms-5">
                                ...
                                <ul>
                                    <li class="ms-5">In foreign exchange received through normal banking channels, or</li>
                                    <li class="ms-5">By debit to NRE account (foreign currency equivalent, as on the date of payment) or debit to FCNR (B) account.</li>
                                </ul>
        ...
        },
        {
            ...
            faqAnswer: `If you are an NRI/PIO/OCI you would have to file your income tax returns if you fulfill either of these conditions:
                        <ul>
                            <li class="ms-5">Your taxable income in India during the year was above the basic exemption limit of INR 1.6 lakh, or</li>
                            <li class="ms-5">You have earned short-term or long-term capital gains from the sale of any investment or asset, even if the gains are less than the basic exemption limit.</li>
                        </ul>
        ...
        },
        {
            ...
            faqAnswer: `Yes, there are two exceptions:
                        <ul>
                            <li class="ms-5">If your taxable income consisted only of investment income (interest) and/or capital gains income and if tax has been deducted at source from such income, you do not have to file your income tax return.</li>
                            <li class="ms-5">If you earned long-term capital gains from the sale of equity shares or equity mutual funds, you do not have to pay any tax and therefore you do not have to include that in your tax return.</li>
                        </ul>
        ...
        },
        {
            ...
            faqAnswer: `<strong>The documents required for salaried employees are:</strong>
                        <ul>
                            <li class="ms-5">Copy of employment contract</li>
                            <li class="ms-5">Latest salary slip</li>
                            <li class="ms-5">Latest work permit</li>
                            <li class="ms-5">Bank statement for 4 months or NRE/NRO account 6 months statement</li>
                            <li class="ms-5">Passport/visa copy</li>
                            <li class="ms-5">Utility bill for address proof</li>
                            <li class="ms-5">PIO/OCI card</li>
                            <li class="ms-5">Power of Attorney (if applicable, in respective bank's format)</li>
                            <li class="ms-5">Customer credit check report</li>
                            <li class="ms-5">Property agreement duly registered or other related documents</li>
                            <li class="ms-5">Income tax returns for the last 2 years</li>
                        </ul>

                        <strong>The documents required for self-employed individuals are:</strong>
                        <ul>
                            <li class="ms-5">Balance sheets and P&L account of the company for the last 3 years</li>
                            <li class="ms-5">Bank account statements for the last 6 months for both company and individual</li>
                            <li class="ms-5">Income tax returns (3 years)</li>
                            <li class="ms-5">Passport/visa copy</li>
                            <li class="ms-5">Utility bill for address proof</li>
                            <li class="ms-5">PIO/OCI card</li>
                            <li class="ms-5">Power of Attorney (if applicable, in respective bank's format)</li>
                            <li class="ms-5">Credit check report</li>
                            <li class="ms-5">Property agreement or other related documents</li>
                        </ul>`
            },
                                ...
                                return (
                                    <div className="accordion-item" key={faqIndex}>
                                        <h2 className="accordion-header" id={`heading${faqIndex}`}>
                                            ...
                                            >
                                                Q{faqIndex}: <span dangerouslySetInnerHTML={{ __html: faq.faqQuestion }} />
                                            </button>
                                        </h2>
                                        <div
                                            ...
                                            <div className="accordion-body">
                                                <ul className="list-group list-group-flush">
                                                    <li className="list-group-item px-0">
                                                        <b>A:</b> <span dangerouslySetInnerHTML={{ __html: faq.faqAnswer }} />
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
