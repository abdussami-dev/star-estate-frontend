                            ...
                            <div className='row g-0 h-100'>
                                ...
                                <div className='col-md-12 crServText'>
                                    <div className='inner bg-gray-gradient-box'>
                                        ...
                                        <article>
                                            <p>Star Estate is a network of professionals with distinguished work experience across India. Our distinct workforce with unique ideas, concepts, and work strategies elevate the business to attain the target and reap massive success.</p>
                                        </article>
                                    </div>
                                </div>
                            </div>
